...
<head>
    ...
    <style>
      ...
      .dropdown-menu a.dropdown-item {
        ...
        color: #02406D;  /* Atur latar belakang kembali ke nilai default */
      }
      ...
      #staticEmail:hover {
        border-color: #02406d; /* Warna border saat hover */
        cursor: pointer;
      }
...
<body style="overflow-x: hidden;">
  ...
  <div class="container">
    <div class="card-slider w-100" id="cardSlider">
      <div class="card">
        <img src="/ArenaFinder/img_asset/pexels-laura-rincón-16477377.jpg" class="card-img-top" alt="..." style="height: 300px">
      ...
      <div class="card">
        <img src="/ArenaFinder/img_asset/pexels-ivan-siarbolin-3787832.jpg" class="card-img-top" alt="..." style="height: 300px">
        <div class="small-box" style="margin-left: 380px; height: 50px;">2/2</div>
        <div class="card-body">
          <h5 class="card-title">Latihan Bersama Badminton TIF PSDKU Nganjuk</h5>
          <h6 class="card-text">Lokasi : GOR Badminton Bung Karno Nganjuk</h6>
      ...
      <div class="card">
        <img src="/ArenaFinder/img_asset/connor-coyne-OgqWLzWRSaI-unsplash.jpg" class="card-img-top" alt="..." style="height: 300px">
        <div class="small-box" style="margin-left: 380px; height: 50px;">2/2</div>
        <div class="card-body">
          <h5 class="card-title">Latihan Bersama Badminton TIF PSDKU Nganjuk</h5>
          <h6 class="card-text">Lokasi : GOR Badminton Bung Karno Nganjuk</h6>
      ...
      <div class="card">
        <img src="/ArenaFinder/img_asset/alex-_AOL4_fDQ3M-unsplash.jpg" class="card-img-top" alt="..." style="height: 300px">
        <div class="small-box" style="margin-left: 380px; height: 50px;">2/2</div>
        <div class="card-body">
          <h5 class="card-title">Latihan Bersama Badminton TIF PSDKU Nganjuk</h5>
          <h6 class="card-text">Lokasi : GOR Badminton Bung Karno Nganjuk</h6>
